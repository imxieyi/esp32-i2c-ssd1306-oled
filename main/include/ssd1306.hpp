...
public:
	 ...
	 */
	uint8_t measure_string(char *str);
	/**
...
// * @param   color   Color of the line
// */
//void ssd1306_draw_hline(uint8_t id, int8_t x, int8_t y, uint8_t w,
//		ssd1306_color_t color);
//
///**
// * @brief   Draw vertical line
...
// * @param   color   Color of the line
// */
//void ssd1306_draw_vline(uint8_t id, int8_t x, int8_t y, uint8_t h,
//		ssd1306_color_t color);
//
///**
// * @brief   Draw a rectangle
...
// * @param   color   Color of the rectangle border
// */
//void ssd1306_draw_rectangle(uint8_t id, int8_t x, int8_t y, uint8_t w,
...
// * @param   color   Color of the rectangle
// */
//void ssd1306_fill_rectangle(uint8_t id, int8_t x, int8_t y, uint8_t w,
//		uint8_t h, ssd1306_color_t color);
//
///**
// * @brief   Draw a circle
...
// * @param   color   Color of the circle
// */
//void ssd1306_draw_circle(uint8_t id, int8_t x0, int8_t y0, uint8_t r,
//		ssd1306_color_t color);
//
///**
// * @brief   Draw a filled circle
...
// * @param   color   Color of the circle
// */
//void ssd1306_fill_circle(uint8_t id, int8_t x0, int8_t y0, uint8_t r,
//		ssd1306_color_t color);
//
///**
// * @brief   Select font for drawing
...
// * @return  Width of the character
// */
//uint8_t ssd1306_draw_char(uint8_t id, uint8_t x, uint8_t y, unsigned char c,
//		ssd1306_color_t foreground, ssd1306_color_t background);
//
///**
// * @brief   Draw string using currently selected font
...
// * @return  Width of the string (out-of-display pixels also included)
// */
//uint8_t ssd1306_draw_string(uint8_t id, uint8_t x, uint8_t y, char *str,
//		ssd1306_color_t foreground, ssd1306_color_t background);
//
///**
// * @brief   Measure width of string with current selected font
